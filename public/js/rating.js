function ratingCreate(button, rating , user_id, movie_id) {
    ...
    $.post("/rating", {rating: rating, user_id: user_id, movie_id: movie_id, _token: CSRF_TOKEN} )
        .done(function (data) {
            if (data.status === "ratingExist"){
                $.post("/rating-update", {rating: rating, user_id: user_id, movie_id: movie_id, _token: CSRF_TOKEN, _method: 'PUT'} )
                    .done(function (data) {
